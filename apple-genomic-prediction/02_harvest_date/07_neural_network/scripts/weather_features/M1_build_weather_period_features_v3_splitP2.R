...
out_csv_file    <- "Input/derived/weather_period_features_v3_splitP2.csv"
out_rdata_file  <- "Input/derived/weather_period_features_v3_splitP2.RData"
report_file     <- "Output/reports/weather_period_features_v3_splitP2_report.txt"
